"use client"
import { Tv, Smartphone, Laptop, Wifi, Flame, Monitor, Users, Settings } from "lucide-react";
    ...
    >
      <div className="grid font-poppins grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            Support for simultaneous viewing on multiple screens: Users of ZumTV
            can enjoy watching multiple channels or programs simultaneously on various 
            screens.
          </motion.p>
